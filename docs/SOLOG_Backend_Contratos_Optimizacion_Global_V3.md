# SOLOG — Contratos Backend de Optimización Global V3
...
> La versión **V3 de este documento** no cambia `contract_version = 2` de las APIs. V3 identifica la revisión documental/contractual.
...
3. **`SOLOG_Backend_Contratos_Optimizacion_Global_V3.md` — contrato de integración frontend vigente.**
4. `SOLOG_Backend_Contratos_Optimizacion_Global_V2.md` — **REEMPLAZADO / histórico**.
5. `SOLOG_Backend_Contratos_Optimizacion_Global_V1.md` — **REEMPLAZADO / histórico**.
6. Motor y modelo de datos vigentes del proyecto donde este contrato no los sustituya explícitamente.

Ante contradicción entre versiones de contratos, **prevalece V3**.

### Alcance acumulado V2 + V3
...
La migración V3 no creó ni modificó datos operativos. Las pruebas fueron de lectura/contrato; no se inició una sesión sintética.

---

# 18. Gate E2E Cajero

El cierre C1 de V3 no modifica el gate E2E anterior.
...
- **bloqueo C1 cerrado**;
- backend desplegado;
- C1 puede reanudarse sin consultas v1 ni valores inventados;
- no queda un bloqueo contractual conocido para las fases actualmente planificadas.

Codex puede reanudar C1 y continuar el plan aprobado con estas restricciones:

- no modificar Supabase/backend;
- V3 reemplaza V2/V1 como contrato primario;
...
- si aparece una necesidad backend no cubierta por V3, detener la fase y devolverla a ChatGPT;
