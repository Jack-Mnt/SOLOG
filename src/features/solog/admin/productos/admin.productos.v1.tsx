...
export function AdminProductsV1() {
  ...
  return <section className="admin-catalog admin-products">
    ...
    <section className="admin-products__section">
      ...
      <div className="admin-table-section admin-catalog__table"><div className="admin-v2-table"><table><thead><tr><th scope="col">Producto</th><th scope="col">C. interno</th><th scope="col">Categoría</th><th scope="col">Grupo</th><th scope="col">Precio</th><th scope="col">Estado</th><th scope="col">Acciones</th></tr></thead><tbody>{visible.rows.map((product) => {
      ...
      })}{!products.length && <tr><td colSpan={7}>No hay productos que coincidan con los filtros locales.</td></tr>}</tbody></table></div></div>
