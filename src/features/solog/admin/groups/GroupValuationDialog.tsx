  ...
  return (
    ...
    >
      <form className="group-valuation-form" id="group-valuation-form" onSubmit={(event) => void submit(event)}>
        <div className="group-valuation-unit-price"><span>Precio unitario</span><strong>{formatAdminCurrency(group.precio)}</strong><small>Solo lectura · Para cambiarlo usa Proponer edición.</small></div>
