...
const ERROR_MESSAGES: Partial<Record<SologErrorCode, string>> = {
  ...
  SOLOG_CATALOG_CHANGE_NOT_IGNORABLE: 'La propuesta ya no puede ignorarse desde su estado actual.',
  SOLOG_CATALOG_CHANGE_NOT_AUTOMATIC: 'Solo las propuestas automáticas pueden ignorarse o reactivarse.',
  SOLOG_CATALOG_AUTOMATIC_DISCARD_FORBIDDEN: 'Las propuestas automáticas no se descartan; ignóralas si no deben seguir generando ruido.',
  SOLOG_GROUP_PRICE_PROPOSAL_CONFLICT: 'El grupo contiene propuestas de precio incompatibles. Revísalas antes de actualizar todo el grupo.',
  SOLOG_INVALID_PRICE_RESOLUTION: 'La resolución de precio seleccionada no es válida.',
