...
const DEVICE_STATE_LABELS: Record<string, string> = {
  ...
  sin_solicitud: "Sin autorización",
...
function formatStockUpdate(confirmedAt: string | null, serverNow: string) {
  ...
  const elapsedMinutes = Math.floor(
    Math.max(0, serverNowMs - confirmedAtMs) / 60_000,
  );
  const relative =
    elapsedMinutes < 60
      ...
      <main className="cajero-main">
        ...
        >
          <div className="details-panel__heading">
            <div>
              <h1 id="details-title">Info de la sede</h1>
              <p>Consulta el estado operativo sin registrar conteos.</p>
            </div>
          ...
          {summary ? (
            <>
              ...
              <div
                ...
                aria-label="Resumen operativo de la sede"
              >
                <article className="cajero-home-metric">
                  ...
                  <div className="cajero-home-metric__value">
                    ...
                    <small>
                      {pluralize(
                        summary.summary.conteo_diario_pendientes,
                        "grupo",
                        "grupos",
                      )}
                    </small>
                ...
                <article className="cajero-home-metric">
                  ...
                  <div className="cajero-home-metric__value">
                    ...
                    <small>
                      {pluralize(
                        summary.summary.revisar_pendientes,
                        "caso",
                        "casos",
                      )}
                    </small>
              ...
              <div className="details-info-cards">
                <section className="details-info-card">
                  <div className="details-info-card__content">
                    <div>
                ...
                <section className="details-info-card">
                  <div className="details-info-card__heading">
                    <h2>Reporte quincenal</h2>
                    <p>Descarga las diferencias finales del período.</p>
                  </div>

                  <div className="details-info-card__export">
                    <div className="export-period__control">
                      <span
                        className={
                          exportPeriod === "previous_biweekly"
                            ? "is-active"
                            : undefined
                        }
                      >
                      ...
                      <label className="export-period__switch">
                        <input
                          type="checkbox"
                          role="switch"
                          aria-label="Cambiar quincena a exportar"
                          disabled={detailsExport.exporting}
                          checked={exportPeriod === "current_biweekly"}
                          onChange={(event) =>
                            setExportPeriod(
                        ...
                        <span className="export-period__track">
                          <span className="export-period__thumb" />
                        </span>
                      </label>

                      <span
                        className={
                          exportPeriod === "current_biweekly"
                            ? "is-active"
                            : undefined
                        }
                      >
                    ...
                    <button
                      ...
                      disabled={detailsExport.exporting}
                      onClick={() =>
                        void detailsExport.exportExcel(exportPeriod)
                      }
                      type="button"
                    >
